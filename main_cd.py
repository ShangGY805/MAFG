...
def train(args):
    dataloaders = utils.get_loaders(args) #获取数据加载器和数据集
    model = CDTrainer(args=args, dataloaders=dataloaders) #获取模型训练器
    model.train_models()    #模型开始训练
...
if __name__ == '__main__':
    ...
    parser.add_argument('--project_name', default='MAFG_LEVIR-256', type=str)
    ...
    parser.add_argument('--data_name', default='LEVIR-256', type=str)
    ...
    parser.add_argument('--net_G', default='MAFG', type=str)
